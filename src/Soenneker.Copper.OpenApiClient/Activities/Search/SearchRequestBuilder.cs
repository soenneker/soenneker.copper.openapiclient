...
namespace Soenneker.Copper.OpenApiClient.Activities.Search
{
    ...
    public partial class SearchRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A List&lt;global::Soenneker.Copper.OpenApiClient.Models.ListActivitiesSearch200ResponseItem&gt;</returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<global::Soenneker.Copper.OpenApiClient.Models.ListActivitiesSearch200ResponseItem>?> PostAsync(global::Soenneker.Copper.OpenApiClient.Models.ListActivitiesSearchRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Soenneker.Copper.OpenApiClient.Models.ListActivitiesSearch200ResponseItem>> PostAsync(global::Soenneker.Copper.OpenApiClient.Models.ListActivitiesSearchRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Soenneker.Copper.OpenApiClient.Models.ListActivitiesSearch200ResponseItem>(requestInfo, global::Soenneker.Copper.OpenApiClient.Models.ListActivitiesSearch200ResponseItem.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Copper.OpenApiClient.Models.ListActivitiesSearchRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Copper.OpenApiClient.Models.ListActivitiesSearchRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
